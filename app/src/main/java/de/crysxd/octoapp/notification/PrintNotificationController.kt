...
class PrintNotificationController(
    ...
    companion object {
        ...
        internal val instance by lazy {
            ...
            PrintNotificationController(
                context = context,
                notificationFactory = PrintNotificationFactory2(context, repository, Injector.get().formatEtaUseCase()),
    ...
    private fun setLast(instanceId: String, print: Print) = sharedPreferences.edit {
        putString("$KEY_LAST_PRINT_PREFIX$instanceId", gson.toJson(print))
    }
